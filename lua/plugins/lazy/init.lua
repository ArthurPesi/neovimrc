...
--[[    {
    ...
    },--]]
    {
        ...
        config = function() require('catppuccin').setup({ transparent_background = true, dim_inactive = { enabled = true, shade = "dark", percentage = 0.15, },}) end,
    },--[[
{
...
lspconfig.omnisharp.setup({
  on_attach = on_attach,
  capabilities = capabilities,
  cmd = { "dotnet", "/home/pesi/.local/share/nvim/mason/packages/omnisharp/libexec/OmniSharp.dll" },
